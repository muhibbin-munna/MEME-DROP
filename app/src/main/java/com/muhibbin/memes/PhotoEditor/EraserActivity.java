package com.muhibbin.memes.PhotoEditor;
...
import com.muhibbin.memes.selffie.view.HoverView;
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.eraseButton:
                if (eraserMainButton.isActivated()) {
                    eraserMainButton.setActivated(false);
                    eraserMainButton.setBackgroundResource(R.drawable.pencil_inactive);
                } else {
                    eraserMainButton.setActivated(true);
                    magicWandMainButton.setActivated(false);
                    mirrorButton.setActivated(false);
                    positionButton.setActivated(false);
                    eraserMainButton.setBackgroundResource(R.drawable.pencil_active);
                    magicWandMainButton.setBackgroundResource(R.drawable.magic_inactive);
                    mirrorButton.setBackgroundResource(R.drawable.mirror);
                    positionButton.setBackgroundResource(R.drawable.magnifier_inactive);
                }
            ...
            case R.id.magicButton:
                if (magicWandMainButton.isActivated()) {
                    magicWandMainButton.setActivated(false);
                    magicWandMainButton.setBackgroundResource(R.drawable.magic_inactive);
                } else {
                    magicWandMainButton.setActivated(true);
                    magicWandMainButton.setBackgroundResource(R.drawable.magic_active);
            ...
            case R.id.mirrorButton:
                if (mirrorButton.isActivated()) {
                    mirrorButton.setActivated(false);
                    mirrorButton.setBackgroundResource(R.drawable.mirror);
                } else {
                    mirrorButton.setActivated(true);
                    mirrorButton.setBackgroundResource(R.drawable.mirror_active);
            ...
            case R.id.positionButton:
                if (positionButton.isActivated()) {
                    positionButton.setActivated(false);
                    positionButton.setBackgroundResource(R.drawable.magnifier_inactive);
                } else {
                    positionButton.setActivated(true);
                    positionButton.setBackgroundResource(R.drawable.magnifier_active);
